...
- [x] Title is "Lumscribe — LMS for Tutors"
...
- [x] Navbar shows: Lumscribe logo, Find a Teacher, Pricing, Log In, Start Free
...
- [x] Page loads successfully
- [x] Title is "Explore Teachers — Lumscribe"
...
- [x] ~~**BUG: Generic page title**~~ — FIXED: Added metadata export with "Pricing — Lumscribe"

## Login Page (`/login`)

- [x] Page loads successfully
- [x] Title is "Sign in — Lumscribe"
...
- [x] Page loads successfully
- [x] Title is "Create account — Lumscribe"
...
- [x] Page loads successfully
- [x] Title is "Student Sign in — Lumscribe"
...
- [x] Page loads successfully
- [x] Title is "Forgot password — Lumscribe"
...
- [x] Page loads successfully
- [x] Title is "Admin Login — Lumscribe"
- [x] "Lumscribe Admin" heading clearly identifies as admin login
